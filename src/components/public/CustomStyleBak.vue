...
<template>
  <div id="custom-style" :contenteditable="false">
    <el-button class="reset-gened-prg-btn" size="mini" @click="clearGenPrg()">修改</el-button>
    <el-button class="collapse-btn" size="mini" :icon="btnIcon" @click="clickEvent()" v-if="true">{{btnTitle}}</el-button>
    <transition
      name="my-trans"
